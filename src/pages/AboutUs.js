  ...
  const domainData = useMemo(
    () => ({
      ...
      ai: {
        ...
        points: [
          "Gain exposure to modern AI-oriented internship structure",
      ...
      finance: {
        ...
        points: [
          ...
          "Experience a cleaner and more professional internship flow",
    ...
    () => [
      {
        ...
        a: "InternovaTech offers structured online internship-style learning experiences with guided modules, dashboard access, assessments, progress tracking, and verified certificates across multiple in-demand domains.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes, InternovaTech is designed for students, freshers, and learners who want guided learning, internship exposure, and a stronger digital profile through structured outcomes.",
      },
    ],
    []
  );
