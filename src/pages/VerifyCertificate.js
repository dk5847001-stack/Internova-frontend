  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Verify InternovaTech certificates using the official certificate ID. Confirm candidate details, internship details, issue date, and certificate authenticity."
      );
    }
            ...
            <div className="row g-4 align-items-center">
              <div className="col-lg-8">
                ...
                <p className="verify-v61-text">
                  ...
                  candidate details, internship information, issue date, and
